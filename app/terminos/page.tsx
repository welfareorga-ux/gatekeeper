        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>Paquete de 20 visitas extra (solo plan Gratis):</strong> S/ 19.00 (pago único) — se usa solo cuando se agotan las visitas incluidas del mes y vence al terminar el mes calendario (hora de Lima) en que se compró. Las visitas no usadas se pierden y no se reembolsan.</li>
