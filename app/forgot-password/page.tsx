      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-2xl">
          <CardHeader className="pb-4">
            ...
            <div className="rounded-md bg-amber-50 border border-amber-200 px-3 py-2 text-xs text-amber-800 mt-2">
              Este servicio es exclusivo para <strong>administradores</strong>. Residentes y vigilantes deben contactar a su administrador para restablecer su contraseña.
            </div>
          </CardHeader>
          <CardContent>
            {enviado ? (
